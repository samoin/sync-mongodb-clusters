...
function validateDatabaseName(databaseName) {
  ...
  for(var i = 0; i < invalidChars.length; i++) {
	//TODO changed here ,i need to read collection "oplog.rs", so i changed here
	console.log("----" + databaseName);
    if(databaseName != "oplog.rs" && databaseName.indexOf(invalidChars[i]) != -1) throw new Error("database names cannot contain the character '" + invalidChars[i] + "'");
  }
}
